...
print('training final model with max_depth=%d, min_samples_leaf=%d' % (10,10))
...
print('Saved decision tree model at : ../model/%s' % 'cancellation-pred-model-decision-tree.bin')    
