...
#validation
print('validation started with C=1.0')
...
print('validation dataset scores -> C=1, auc = %0.3f ± %0.3f' % (np.mean(auc), np.std(auc))) 


#training final model.
print('training final model with C=1')
...
print('Saved decision tree model at : ../model/%s' % 'cancellation-pred-model-lr.bin')    
